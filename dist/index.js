...
function declarationGeneratorMixin(Generator) {
  return class extends Generator {
...
function declarationsGeneratorMixin(Generator) {
  return class extends Generator {
...
function decoratedDeclarationGeneratorMixin(Generator) {
  return class extends Generator {
...
function newlineToSpace$1(string) {
  return string.replace(newline$1, '\n');
}

function trimAroundNewline(strings, ...values) {
  return values.reduce(
    (acc, value, index) => acc + value + newlineToSpace$1(strings[index + 1]),
    newlineToSpace$1(strings[0])
  ).trim();
}
...
function indentGeneratorMixin(Generator) {
  return class extends Generator {
    constructor(tree, options) {
      super(tree, options);
...
function messageGeneratorMixin(Generator) {
  return class extends Generator {
    generateMessage({ props: { name, id, fields } }, scope) {
      ...
      return trimAroundNewline`
        registerMessage('${name.value}', ${id.value}, () => {
...
function rootGeneratorMixin(Generator) {
  return class extends Generator {
    generateRoot() {
...
function blockParserMixin(Parser) {
  return class extends Parser {
    parseBlock() {
...
function constParserMixin(Parser) {
  return class extends Parser {
    parseConst() {
...
function declarationsParserMixin(Parser) {
  return class extends Parser {
    parseDeclarations() {
      const declarations = [];
...
function decoratedDeclarationParserMixin(Parser) {
  return class extends Parser {
...
function enumParserMixin(Parser) {
  return class extends Parser {
    parseEnum() {
...
function fieldParserMixin(Parser) {
  return class extends Parser {
    parseField() {
      const type = this.parseType();
...
function identParserMixin(Parser) {
  return class extends Parser {
    parseIdent(role) {
...
function messageParserMixin(Parser) {
  return class extends Parser {
    parseMessage() {
...
function structParserMixin(Parser) {
  return class extends Parser {
    parseStruct() {
...
function structNameParserMixin(Parser) {
  return class extends Parser {
    parseStructName() {
...
function typeParserMixin(Parser) {
  return class extends Parser {
    parseType() {
...
module.exports = generateFromSource;